...
const Navbar = () => {
  const Links = [
    {
      icon1: <ion-icon style={{fontSize:'35px',fontWeight:'bold'}}  name="home-outline"></ion-icon>,
      link: "/",
    },
    {
      name: "SEO services",
  ...
  return (
    <div className="w-full fixed">
      ...
      >
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static text-white-300 md:z-auto z-[-1] left-0 w-full md:w-auto last:border-r-0 ${
        ...
        >
          {Links.map((link) => (
            ...
            >
              <a href={link.link} className="flex items-center justify-center break-words">
