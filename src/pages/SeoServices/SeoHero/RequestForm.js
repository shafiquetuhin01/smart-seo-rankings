...
const RequestForm = () => {
  return (
    <div class="request-form request-bg card w-80 bg-neutral text-neutral-content">
  <div class="card-body items-center text-center">
    <h2 class="card-title text-white italic">Request a Quote and !</h2>
    <h2 class="card-title text-xl text-warning italic">FREE SEO Audit Report</h2>
    ...
    <textarea placeholder="Project Details" name="details" cols="30" className="w-full h-16 rounded p-2" rows="10"></textarea>
    <div class="mt-3 card-actions justify-center">
      <button class="bg-gradient-to-t from-warning to-secondary btn text-black text-xl capitalize font-bold w-full h-9 btn-warning">Submit Request</button>
    </div>
  </div>
</div>
  );
