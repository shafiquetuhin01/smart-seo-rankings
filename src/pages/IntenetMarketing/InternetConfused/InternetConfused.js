...
const InternetConfused = () => {
  return (
    ...
    >
      <div className="lg:flex lg:flex-row-reverse gap-5 justify-center items-center w-11/12 mx-auto pt-8 py-5 ">
        <div className="w-7/12">
          <h2 className="text-[46px] leading-[51px] font-bold text-white text-left">
          ...
          <Link to="#">
          <p className="text-white text-lg mt-3">Call <span className="text-[34px] font-bold ">855-444-4777</span></p>
          </Link>
