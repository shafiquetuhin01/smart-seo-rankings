        ...
        rows: [
            {
                ...
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' /> What is digital marketing?</div>,
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' /> Does my business need digital marketing services?</div>,
                content:
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' /> What are the types of digital marketing?</div>,
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' /> How can digital marketing benefit my business?</div>,
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' />  What is a digital marketing strategy?</div>,
        ...
        rows: [
            {
                ...
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' />  Does digital marketing work for all industries?</div>,
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' />  Can digital marketing help me outdo my competitors?</div>,
                content:
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' />  Why isn’t my digital marketing strategy working?</div>,
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' />  How soon can I see results from digital marketing?</div>,
            ...
            {
                title: <div className='flex justify-center'><FaPlus className='mr-2 mt-1 text-secondary' />   How can Search Berg help me get started?</div>,
