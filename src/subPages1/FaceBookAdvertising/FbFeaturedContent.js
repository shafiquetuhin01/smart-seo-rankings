...
import FbSingleFeatured from "./FbSingleFeatured";
const FbFeaturedContent = () => {
  const contents = [
    {
      _id: 1,
  ...
  return (
    <section className="w-11/12 mx-auto py-6">
      <div>
        <h3 className="text-4xl text-info font-bold text-center my-2">
        ...
        <p className="text-xl text-center my-4">
          To read more featured content on our Facebook advertising strategy and
          social media management, please visit our{" "}
...
export default FbFeaturedContent;
