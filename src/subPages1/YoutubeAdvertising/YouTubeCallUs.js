...
const YouTubeCallUs = () => {
    return (
      ...
      Looking for a {" "}
        <span className='text-secondary'>Massive Platform</span> to Advertise Your Business?
      </p>
      <p className="italic text-2xl text-center text-info">To Design Call us at 855-444-4777 to kick-start your YouTube advertising campaign!</p>
