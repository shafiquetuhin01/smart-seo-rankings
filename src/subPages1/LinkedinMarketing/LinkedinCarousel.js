...
import YouTubeCallUs from "../YoutubeAdvertising/YouTubeCallUs";


const LinkedinCarousel = () => {
    return (
        <section className="w-full py-5">
        <div className="test-carousel py-10  text-info">
          <h2 className="text-4xl text-info text-center font-bold">Read Our <span className="text-secondary">Client Testimonials!</span></h2>
        ...
        <p className="text-lg text-center my-4">For more Search Berg reviews, click <Link className="underline text-info" to="#">here</Link> and also check us out our <Link className="underline text-info" to="#">Google reviews</Link> and <Link className="underline text-info" to="#">Sitejabber reviews.</Link></p>
          <Swiper
            navigation={true}
            modules={[Navigation]}
          ...
          >
            <SwiperSlide>
              <div className="flex justify-center items-center  text-info">
