    ...
    >
      <div className="lg:flex gap-5 justify-center items-center w-11/12 mx-auto pt-8 py-5 ">
        <div className="w-full lg:w-7/12">
          ...
          LinkedIn Marketing:{" "}
            <span className="text-white"> LinkedIn Marketing:
Leveraging The Biggest B2B Platform To Increase Sales</span>
          </h2>

          <h2 className="mt-6 text-white text-2xl text-center lg:text-left">
          Target high-quality leads and watch your sales catapult!
          </h2>
          ...
          <div className="flex justify-start items-center mt-5">
            ...
            <div>
              ...
              <div className="flex items-center justify-center">
                <Link to="/chatBox">
                  <h3 className="underline text-left underline-offset-4  text-blue-500 text-xl  px-2 font-bold">
                    Start A Live Chat
                  </h3>
                </Link>
                <span className="text-white text-3xl  px-2 ">l</span>
                <Link to="/request">
                  <h3 className="underline underline-offset-4 text-blue-500 text-xl  ml-1 px-2 font-bold">
                    Request A Quote
                  </h3>
                </Link>
              </div>
        ...
        <div className="w-full lg:w-5/12">
          <img src="https://i.ibb.co/nD3TRpL/hero-img2.png" alt="seo-img" />
        </div>
      </div>
    </section>
    );
